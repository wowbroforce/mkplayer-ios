Pod::Spec.new do |spec|
    ...
    spec.source       = { :http => "https://mkplayer.z13.web.core.windows.net/ios_tvos_rc_build/MKPlayer-1.4.1.rc.zip" }
    ...
    spec.ios.dependency 'BitmovinPlayer', '3.31.0'
