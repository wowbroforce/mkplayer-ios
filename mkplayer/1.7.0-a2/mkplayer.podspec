Pod::Spec.new do |spec|
    ...
    spec.source       = { :http => "https://mkplayer.z13.web.core.windows.net/ios_tvos/MKPlayer-1.7.0-a2.zip" }
    ...
    spec.ios.dependency 'BitmovinAnalyticsCollector/Core', '3.1.1'
    spec.ios.dependency 'BitmovinAnalyticsCollector/BitmovinPlayer', '3.1.1'
    ...
    spec.tvos.dependency 'BitmovinAnalyticsCollector/Core', '3.1.1'
    spec.tvos.dependency 'BitmovinAnalyticsCollector/BitmovinPlayer', '3.1.1'
