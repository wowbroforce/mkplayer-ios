Pod::Spec.new do |spec|
    ...
    spec.source       = { :http => "https://mkplayer.z13.web.core.windows.net/ios_tvos/MKPlayer-1.0.14.zip" }
    ...
    spec.ios.dependency 'BitmovinPlayer', '3.13.0'
    ...
    spec.tvos.dependency 'BitmovinPlayer', '3.13.0'
