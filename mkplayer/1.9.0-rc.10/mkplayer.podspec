Pod::Spec.new do |spec|
    ...
    spec.source       = { :http => "https://mkplayer.z13.web.core.windows.net/ios_tvos/MKPlayer-1.9.0-rc.10.zip" }
    ...
    spec.ios.dependency 'BitmovinPlayer', '3.42.0'
    ...
    spec.tvos.dependency 'BitmovinPlayer', '3.42.0'
