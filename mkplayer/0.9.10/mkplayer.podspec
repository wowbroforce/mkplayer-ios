Pod::Spec.new do |spec|
    ...
    spec.source       = { :http => "https://mkplayer.z13.web.core.windows.net/ios_tvos/MKPlayer-0.9.10.zip" }
    ...
    spec.ios.dependency 'BitmovinPlayer'
    ...
    spec.tvos.dependency 'BitmovinPlayer'
