Pod::Spec.new do |spec|
    ...
    spec.source       = { :http => "https://mkplayer.z13.web.core.windows.net/ios_tvos/MKPlayer-1.0.0.zip" }
    ...
    spec.ios.dependency 'BitmovinPlayer', '2.64.0'
    ...
    spec.tvos.dependency 'BitmovinPlayer', '2.64.0'
