Pod::Spec.new do |spec|
    ...
    spec.source       = { :http => "https://mkplayer.z13.web.core.windows.net/ios_tvos/MKPlayer-1.10.0-rc.1.zip" }
    ...
    spec.ios.dependency 'BitmovinPlayer', '3.47.0'
    ...
    spec.tvos.dependency 'BitmovinPlayer', '3.47.0'
