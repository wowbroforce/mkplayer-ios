Pod::Spec.new do |spec|
    ...
    spec.source       = { :http => "https://mkplayer.z13.web.core.windows.net/ios_tvos_rc_build/MKPlayer-1.0.35-f.1.zip" }
    ...
    spec.ios.dependency 'BitmovinPlayer', '3.28.0'
    ...
    spec.tvos.dependency 'BitmovinPlayer', '3.28.0'
