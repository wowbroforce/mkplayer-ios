Pod::Spec.new do |spec|
    ...
    spec.source       = { :http => "https://mkplayer.z13.web.core.windows.net/ios_tvos_rc_build/MKPlayer-1.0.36-b.3.zip" }
    ...
    spec.ios.dependency 'BitmovinPlayer', '3.29.0-b.3'
    ...
    spec.tvos.dependency 'BitmovinPlayer', '3.29.0-b.3'
